...
class DirectoryClass {
    constructor() {
        ...
        this.data['GBC2VA3YMAIVB3A77VNRPKMQI3RAPDUDDP7JI2PE426MGKDDJFPRVWP7'] = {
  name: 'SeagullCash',
  website: 'https://linktr.ee/boredseagullclub',
  logo: 'https://xpcdn.xpmarket.com/storage/logo/SeagullCash_rNHeGnj4kqGSVyFzDcoyi3gsp1bdPuGeNK.webp',
  assets: [
    {
      code: 'SeagullCash',
      ...
      desc: 'SeagullCash is a liquidity management layer between Stellar and XRP, providing a seamless bridge.',
      conditions: 'There will only ever be 999,999,999 SeagullCash tokens in existence.',
      image: 'https://xpcdn.xpmarket.com/storage/logo/SeagullCash_rNHeGnj4kqGSVyFzDcoyi3gsp1bdPuGeNK.webp',
    }
  ]
};
